...
//     console.log(`mouseObjext + ${this.mouse}`);

//     const mouse = new Mouse(containerWidth, containerHeight, 100);
//     const obstacle = new Obstacle(containerWidth, containerHeight);
//     const cheese = new Cheese(containerWidth, containerHeight);

//     const game = new Game(mouse, cheese, obstacle);
//     game.startGame();
//     // startGame();
//   });
//};
